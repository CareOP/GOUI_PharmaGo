        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">PharmaGO Health</span>
            </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              End-to-end SaaS platform connecting patients, doctors, hospitals, and pharmacies 
              with AI-driven scheduling, symptom assessment, and seamless prescription fulfillment.
            </p>
            ...
            <CardContent className="p-8 md:p-12 relative">
              ...
              <div className="relative max-w-3xl mx-auto text-center space-y-6">
                ...
                <p className="text-lg opacity-90">
                  Join thousands of healthcare providers already using PharmaGO Health 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">PharmaGO Health</span>
            </div>
